...
export const getAggregatedData = async () => {
  ...
  for (const user of users) {
    ...
    const wxTemplateParams = [
      { name: toLowerLine('toName'), value: user.name, color: `#${ (0xEE7AE9).toString(16).padEnd(6, '0') }` },
      { name: toLowerLine('date'), value: `${selfDayjs().format('YYYY-MM-DD')} ${weekList[selfDayjs().format('d')]}`, color: `#${ (0x000000).toString(16).padEnd(6, '0') }` },
      { name: toLowerLine('province'), value: user.province || config.PROVINCE, color: `#${ (0x000000).toString(16).padEnd(6, '0') }` },
      { name: toLowerLine('city'), value: user.city || config.CITY, color: `#${ (0x000000).toString(16).padEnd(6, '0') }` },
      { name: toLowerLine('weather'), value: weather, color: `#${ (0x000000).toString(16).padEnd(6, '0') }` },
      { name: toLowerLine('minTemperature'), value: minTemperature, color: `#${ (0x000000).toString(16).padEnd(6, '0') }` },
      { name: toLowerLine('maxTemperature'), value: maxTemperature, color: `#${ (0x000000).toString(16).padEnd(6, '0') }` },
      ...
      { name: toLowerLine('birthdayMessage'), value: birthdayMessage, color: `#${ (0x000000).toString(16).padEnd(6, '0') }` },
      { name: toLowerLine('noteEn'), value: noteEn, color: `#${ (0x000000).toString(16).padEnd(6, '0') }` },
      { name: toLowerLine('noteCh'), value: noteCh, color: `#${ (0x000000).toString(16).padEnd(6, '0') }` },
      ...
      { name: toLowerLine('poetryContent'), value: poetryContent, color: `#${ (0x000000).toString(16).padEnd(6, '0') }` },
